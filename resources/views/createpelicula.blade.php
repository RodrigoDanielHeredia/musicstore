...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{URL('pelicula')}}{{isset($data) ? '/' . $data->id : ''}}" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" name="director" placeholder="director" class="form-control" value="{{isset($data) ? $data->director : ''}}">
